        ...
        <div className="grid gap-10 md:grid-cols-12">
          ...
          <div className="md:col-span-3">
            ...
            <ul className="mt-5 space-y-3 text-sm">
              {nav.map((n) => (
                <li key={n.href}>
                  <a href={n.href} className="text-white/80 hover:text-flame transition">{n.label}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="md:col-span-4">
            ...
            <ul className="mt-5 space-y-3 text-sm text-white/80">
              ...
              <li>
                <a href={CONTACTS.whatsapp} target="_blank" rel="noreferrer" className="hover:text-flame transition">WhatsApp</a>
                {" · "}
                <a href={CONTACTS.telegram} target="_blank" rel="noreferrer" className="hover:text-flame transition">Telegram</a>
              </li>
              <li>
