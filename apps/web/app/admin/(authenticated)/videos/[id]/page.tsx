...
import { fetchVideo } from "@/lib/admin-api";
  ...
  return (
    <div className="space-y-6">
      ...
      <header>
        ...
        <h1 className="mt-2 font-display text-3xl tracking-tight">{row.title}</h1>
      </header>
      <section className="rounded-2xl border border-line bg-white p-5 max-w-3xl">
        <VideoForm mode="edit" initial={row} />
      </section>
    </div>
  );
}
