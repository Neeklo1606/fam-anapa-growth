            ...
            {open && (
              ...
              >
                ...
                >
                  ...
                  <div className="relative flex items-center justify-between p-5 pt-safe">
                    <span className="text-[10px] uppercase tracking-[0.3em] text-white/55 font-mono-pro">Меню</span>
                    <button
                      type="button"
